...
<html>
	<head>
		...
		<!--[if lte IE 8]><script src="<%= basePath %>/css/ie/html5shiv.js"></script><![endif]-->
		...
		<noscript>
			...
			<link rel="stylesheet" href="<%= basePath %>/css/style-desktop.css" />
			<link rel="stylesheet" href="<%= basePath %>/css/style-wide.css" />
		</noscript>
		<!--[if lte IE 8]><link rel="stylesheet" href="<%= basePath %>/css/ie/v8.css" /><![endif]-->
	</head>
	<!--
